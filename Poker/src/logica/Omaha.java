...
public class Omaha implements GeneralJuego {
    ...
    public Omaha(ArrayList<Jugador> pJugadores) {
        
        this.CartasVisibles = 5;
        this.CartasPrivadas = 4;
            ...
            for(int j=0; j< Jugadores.size(); j++)
                {
                    ...
                    Jugadores.get(j).setMejorMano(mano.getMejorManoO( Jugadores.get(j).getCartasJugador()));  
